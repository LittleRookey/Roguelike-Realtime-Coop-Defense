...
public class LobbyManager : MonoBehaviour {
    ...
    private Player GetPlayer() {
        return new Player(AuthenticationService.Instance.PlayerId, null, new Dictionary<string, PlayerDataObject> {
            ...
            { KEY_PLAYER_CHARACTER, new PlayerDataObject(PlayerDataObject.VisibilityOptions.Public, PlayerCharacter.Magician.ToString()) }
        });
    }
    ...
    public async void CreateLobby(string lobbyName, int maxPlayers, bool isPrivate, GameMode gameMode) {
        ...
        CreateLobbyOptions options = new CreateLobbyOptions {
            ...
            Data = new Dictionary<string, DataObject> {
                ...
                { KEY_START_GAME, new DataObject(DataObject.VisibilityOptions.Member, "0") } // lobby relay code
            }
        };
