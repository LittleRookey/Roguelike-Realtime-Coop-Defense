...
public class LobbyUI : MonoBehaviour {
    ...
    [SerializeField] private Button changeMagicianButton;
    ...
    private void Awake() {
        ...
        changeMagicianButton.onClick.AddListener(() =>
        {
            LobbyManager.Instance.UpdatePlayerCharacter(LobbyManager.PlayerCharacter.Magician);
        });
